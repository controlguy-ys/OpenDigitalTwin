...
describe('SceneExplorerV6', () => {
  it('really collapses, restores local expansion after search, and retains matching ancestors', () => {
    ...
    fireEvent.keyDown(filteredFixtures, { key: 'ArrowRight' })
    fireEvent.keyDown(filteredFixtures, { key: 'ArrowLeft' })
    expect(screen.getByRole('treeitem', { name: 'Groups' })).toHaveFocus()
