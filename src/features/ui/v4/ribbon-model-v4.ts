...
const SECTION_COMMAND_IDS_V4: Readonly<Record<AppCommandSectionV4, readonly string[]>> = Object.freeze({
  ...
  connectivity: Object.freeze(['connectivity.mode.server', 'connectivity.details.open']),
...
const ITEM_SPECS_BY_COMMAND_ID_V4: Readonly<Record<string, RibbonItemSpecV4>> = Object.freeze({
  ...
  'connectivity.mode.server': Object.freeze({ commandId: 'connectivity.mode.server', priority: 10, iconKey: 'server' }),
  'connectivity.details.open': Object.freeze({ commandId: 'connectivity.details.open', priority: 20, iconKey: 'server' }),
